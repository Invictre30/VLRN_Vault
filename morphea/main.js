...
var productsData = [
  ...
  { name: 'Orbit Lips', line: 'Makeup', cat: 'makeup', desc: 'High-shine lip tint in five cosmic shades: Petal Pink, Stellar Red, Solar Gold, Crimson Nova, Galaxy Fuchsia.', img: BASE + 'Liptint1.jpg', glow: 'rgba(196, 79, 208, 0.4)' },
  ...
  { name: 'Cosmic Base Collection (All Shades) line: 'Makeup', cat: 'makeup', desc: 'Vials of body-safe loose glitter — blue, fuchsia, purple, hearts, and pearl — for the full supernova effect.', img: BASE + 'Bottles1.jpg', glow: 'rgba(168, 85, 224, 0.4)' },
